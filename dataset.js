...
d2.set_img(0, {imgtitle: "수신데이터 확인",imglog: "2.훈련데이터 6만개 테스터 데이터 1만개, 이미지사이즈 28,28 1채널 그레이, 정답데이터 정수형",imgurl: "",sourceurl:"https://github.com/dptj13/al_trian_0317/blob/main/ClassificationSoftmax_fashionmnist/Examp_dassification_fashionMnist.lpynb.py"})
d2.set_img(0, {imgtitle: "훈련데이터 minmax 정규환",imglog: "3.훈련데이터의 0 ~ 1 사잇값으로 정규화 실행",imgurl: "",sourceurl:"https://github.com/dptj13/al_trian_0317/blob/main/ClassificationSoftmax_fashionmnist/Examp_dassification_fashionMnist.lpynb.py"})
d2.set_img(0, {imgtitle: "데이터셔플링 및 정답일치성확인",imglog: "4.데이터셔플링 후 정답과 일치하도록 셔플이 되었는지 확인 작업",imgurl: "",sourceurl:"https://github.com/dptj13/al_trian_0317/blob/main/ClassificationSoftmax_fashionmnist/Examp_dassification_fashionMnist.lpynb.py"})
