...
d1.set_img(0, {imgtitle: "보스턴 데이터 수신",imglog: "텐서플로우 보스턴 데이터셋 수신확인",imgurl: "",sourceurl:"https://github.com/dptj13/al_trian_0317/blob/main/LinearRegression/examp_LinearRegression_bostonHousing.py",});
d1.set_img(0, {imgtitle: "데이터 특성 파악",imglog: "각 필드별 데이터의 특성의 의미 및 값을 확인",imgurl: "",sourceurl:"https://github.com/dptj13/al_trian_0317/blob/main/LinearRegression/examp_LinearRegression_bostonHousing.py",});
d1.set_img(0, {imgtitle: "데이터 연관성 확인",imglog: "가격정답과 데이터의 특성별 상호 연관도를 파악",imgurl: "",sourceurl:"https://github.com/dptj13/al_trian_0317/blob/main/LinearRegression/examp_LinearRegression_bostonHousing.py",});
d1.set_img(0, {imgtitle: "데이터 분포도 파악",imglog: "히스토그램을 이용하여 데이터의 분포와 이상치 데이터를 확인",imgurl: "",sourceurl:"https://github.com/dptj13/al_trian_0317/blob/main/LinearRegression/examp_LinearRegression_bostonHousing.py",});
d1.set_img(0, {imgtitle: "데이터 분포도 전환",imglog:"훈련 전처리를 위한 데이터를 평균 0 표준절차 1로 구성된 정규분포로 변환",imgurl: "",sourceurl:"https://github.com/dptj13/al_trian_0317/blob/main/LinearRegression/examp_LinearRegression_bostonHousing.py",});
d1.set_img(0, {imgtitle: "순차모델구성 및 훈련실행",imglog:"평균제곱오차법을 이용한 손실함수와 경사하강법을 이용한 최적화 함수로 컴파일 및 최적화된 훈련 15회 실행",imgurl: "",sourceurl:"https://github.com/dptj13/al_trian_0317/blob/main/LinearRegression/examp_LinearRegression_bostonHousing.py",});
d1.set_img(0, {imgtitle: "훈련 결과 시각화",imglog: "훈련 결과인 mse 손실값의 변화를 시각화 표현 ",imgurl: "",sourceurl:"https://github.com/dptj13/al_trian_0317/blob/main/LinearRegression/examp_LinearRegression_bostonHousing.py",});
d1.set_img(0, {imgtitle: "모델의 예측 결과 측정",imglog:"테스트 데이터를 주입하여 예측결과를 인출하고 실제 정답과 차이를 정확률로 표시 ",imgurl: "",sourceurl:"https://github.com/dptj13/al_trian_0317/blob/main/LinearRegression/examp_LinearRegression_bostonHousing.py",});

d1.set_content("캘리포니아 주택 가격 예측 선형 회귀모델");
d1.set_img(1, {imgtitle: "캘리포니아 주택 특성데이터 수신 및 분석",imglog:"사이킷런에서 제공하는 캘리포니아 주택 가격에 따른 데이터특성(x)들의 모음과 그에 따른 가격정보(y)",imgurl: "",sourceurl: "",});
d1.set_img(1, {imgtitle: "주택가격 특성과 가격의 연관성 분석",imglog: "주택의 특성별 산점도 분석으로 가격에 따른 선형성 확인",imgurl: "",sourceurl: "",});
...
d1.set_img(1, {imgtitle: "이상 데이터제거",imglog:"범위를 벗어나거나 이상치 데이터는 성능에 치명적인 영향을 줄 수 있으므로 이상치 및 범위를 벗어나 데이터를 제거하여 데이터 정체를 수행",imgurl: "",sourceurl: "",});
...
d1.set_img(2, {imgtitle: "1년후 당뇨상태 예측",imgurl: "",imglog: "",sourceurl:"https://docs.google.com/document/d/1rNVbHnhYGoozaqX_RsD3cErmKYzGUMvba9ihxbP2CKk/edit?usp=drive_link",}); //이미지타이틀
...
d2.set_img(1, {imgtitle: "수신데이터 확인",imglog: "2.훈련데이터 6만개 테스터 데이터 1만개, 이미지사이즈 28,28 1채널 그레이, 정답데이터 정수형",imgurl: "",sourceurl:"https://github.com/dptj13/al_trian_0317/blob/main/ClassificationSoftmax_fashionmnist/Examp_dassification_fashionMnist.lpynb.py"})
d2.set_img(1, {imgtitle: "훈련데이터 minmax 정규환",imglog: "3.훈련데이터의 0 ~ 1 사잇값으로 정규화 실행",imgurl: "",sourceurl:"https://github.com/dptj13/al_trian_0317/blob/main/ClassificationSoftmax_fashionmnist/Examp_dassification_fashionMnist.lpynb.py"})
d2.set_img(1, {imgtitle: "데이터셔플링 및 정답일치성확인",imglog: "4.데이터셔플링 후 정답과 일치하도록 셔플이 되었는지 확인 작업",imgurl: "",sourceurl:"https://github.com/dptj13/al_trian_0317/blob/main/ClassificationSoftmax_fashionmnist/Examp_dassification_fashionMnist.lpynb.py"})
...
d2.set_img(1, {imgtitle: "모델컴파일 및 훈련실행",imglog: "6.flattan으로 완전층 연결후 다중분류모델로 softmax 활성화 함수로 10class 출력",imgurl: "https://drive.google.com/file/d/1oMkFBlgb0A8arfFCUHZPxD2_mDntC1F0/view?usp=drive_link",sourceurl:"https://github.com/dptj13/al_trian_0317/blob/main/ClassificationSoftmax_fashionmnist/Examp_dassification_fashionMnist.lpynb.py"})
d2.set_img(1, {imgtitle: "훈련결과 시각화",imglog: "7.훈련 종료 후 손실 및 정확도 시각화 표현",imgurl: "https://drive.google.com/file/d/1OaEfO2e16D5DF3w83e-rv7q1rHIzOjNC/view?usp=drive_link",sourceurl:"https://github.com/dptj13/al_trian_0317/blob/main/ClassificationSoftmax_fashionmnist/Examp_dassification_fashionMnist.lpynb.py"})
d2.set_img(1, {imgtitle: "테스트 데이터 예측",imglog: "8.모델의 테스터 데이터 예측과 예측결과 시각화",imgurl: "https://drive.google.com/file/d/1G-w73IA6aCZq901bbLtGed4GQBHb5tVS/view?usp=drive_link",sourceurl:"https://github.com/dptj13/al_trian_0317/blob/main/ClassificationSoftmax_fashionmnist/Examp_dassification_fashionMnist.lpynb.py"})
d2.set_img(1, {imgtitle: "모델 및 인코더 저장",imglog: "9.훈련된 모델의 저장과 레이블이 연결된 인코더 파일로 저장",imgurl: "9.https://drive.google.com/file/d/17y3mhXumVwK0CAzVyeOQ3td7xkeuEE-n/view?usp=drive_link",sourceurl:"https://github.com/dptj13/al_trian_0317/blob/main/ClassificationSoftmax_fashionmnist/Examp_dassification_fashionMnist.lpynb.py"})
d2.set_img(1, {imgtitle: "모델과 인코더 불러오기",imglog: "실제이미지 측정을 위해 훈련된 모델과 라벨 인코더 다시 불러오기",imgurl: "10.https://drive.google.com/file/d/1qgclJaZT8DPUTDEX4L2XEPHQPZwJ9pdN/view?usp=drive_link",sourceurl:"https://github.com/dptj13/al_trian_0317/blob/main/ClassificationSoftmax_fashionmnist/Examp_dassification_fashionMnist.lpynb.py"})
...
d2.set_img(1, {imgtitle: "실제 이미지 예측결과 시각화",imglog: "실제 이미지를 예측한 결과를 시각화하여 표현",imgurl: "https://drive.google.com/file/d/1GhYHm7N64ooca8N9pkXynMcpbKa1ecMp/view?usp=drive_link",sourceurl:"https://github.com/dptj13/al_trian_0317/blob/main/ClassificationSoftmax_fashionmnist/Examp_dassification_fashionMnist.lpynb.py"})
