...
plt.subplot(2,2,1);plt.hist(x_data[:,2])
plt.subplot(2,2,2)
plt.hist(x_data[:,3])
plt.subplot(2,2,3);plt.hist(x_data[:,4])
plt.subplot(2,2,4);plt.hist(x_data[:,5])
plt.show()
...
plt.figure(figsize=(8,4))
plt.subplot(3,3,1)
plt.scatter(x_data[:,0],y_data,s=1);plt.title(feature[0])
plt.subplot(3,3,2)
plt.scatter(x_data[:,1],y_data,s=1);plt.title(feature[1])
plt.subplot(3,3,3)
plt.scatter(x_data[:,2],y_data,s=1);plt.title(feature[2])
plt.subplot(3,3,4)
plt.scatter(x_data[:,3],y_data,s=1);plt.title(feature[3])
plt.subplot(3,3,5)
plt.scatter(x_data[:,4],y_data,s=1);plt.title(feature[4])
plt.subplot(3,3,6)
plt.scatter(x_data[:,5],y_data,s=1);plt.title(feature[5])
plt.subplot(3,3,7)
plt.scatter((x_data[:,6]+x_data[:,7])/len(x_data),y_data,s=1);plt.title(feature[6])    
...
#2(40) 3(5) 4(8000) 5(200) 
plt.subplot(2,2,1)
plt.hist(x_data[:,2]);plt.subplot(2,2,2)
plt.hist(x_data[:,3]);plt.subplot(2,2,3)
plt.hist(x_data[:,4]);plt.subplot(2,2,4)
plt.hist(x_data[:,5])
plt.show()
...
fhist = model.fit(x_train,y_train,epochs=300,batch_size=len(x_train))
...
#테스트 데이터를 측정후 실제 정답과 예측정답의 정확률을 출력해보세요
