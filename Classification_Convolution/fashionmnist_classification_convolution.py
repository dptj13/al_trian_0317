...
#     activation=None
# )
# tf.keras.layers.GlobalAveragePooling2D - 단일 특성맵 전체의 평균을 산출한다.(완전연결층을)
...
import numpy as np
img_res = tf.keras.utils.load_img("search.pstatic.jpg",target_size=(52,52),interpolation='nearest',
